...
class Format
{
    ...
    {
        $valid = in_array($type, array("php", "moment", "datepicker", "flatpickr"));
    ...
    {
        $valid = in_array($type, array("php", "moment", "flatpickr"));
     ...
     * @return string
     */
    public function getDateTimeFormat($type = "php")
    {
     ...
     * @return string
     */
    protected function getFlatpickrTimeFormat($format)
    {
        $replace = array(
            "a" => "K",
            "A" => "K",
