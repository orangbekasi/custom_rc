...
class Input
{
     ...
     * @return array
     */
    public function getAll($skipTokenCheck = false)
    {
    ...
    public function get($key, $skipTokenCheck = false)
    {
        $this->init($skipTokenCheck);
     ...
     * @return boolean
     */
    public function has($key, $skipTokenCheck = false)
    {
        $this->init($skipTokenCheck);
     ...
     * @return array
     */
    public function fill(array $fields, $skipTokenCheck = false)
    {
        $this->init($skipTokenCheck);
        $result = array();
    ...
    protected function init($skipTokenCheck)
    {
        if (empty($this->data)) {
            ...
            if (!$skipTokenCheck && $this->autoTokenCheck) {
                $this->checkToken();
            }
        }
    }
